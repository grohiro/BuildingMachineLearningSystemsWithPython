# A copy of plot_kmeans_example.py
...
def plot_clustering(x, y, title, mx=None, ymax=None, xmin=None, km=None):
    ...
    # pylab.xtics([w*7*24 for w in range(10)], ['week %i'%w for w in range(10)])
...
xw1 = norm(loc=0.3, scale=.15).rvs(30)
yw1 = norm(loc=0.3, scale=.15).rvs(30)

xw2 = norm(loc=0.7, scale=.15).rvs(30)
yw2 = norm(loc=0.6, scale=.15).rvs(30)

xw3 = norm(loc=0.2, scale=.15).rvs(30)
yw3 = norm(loc=0.8, scale=.15).rvs(30)
